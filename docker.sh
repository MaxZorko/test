...
sudo docker run --rm --name db -d -e POSTGRES_PASSWORD=${dbpass} -p 5432:5432 -v db:/var/lib/postgresql/data/ us.gcr.io/gcp101233-lv61301devops/646/postgres_lv646:latest
